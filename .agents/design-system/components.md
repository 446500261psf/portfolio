...
Meet-style light blue gradient shell. Persona: precise, concise plan coach.

| Step | Role |
|---|---|
| Meet | Greeting + tip → quick examples → composer |
| Typing | iOS keyboard up · user typing |
| Thinking | ✦ highlight flash |
